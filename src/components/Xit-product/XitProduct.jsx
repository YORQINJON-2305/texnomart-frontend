...
const XitProduct = () => {
    ...
    return (
        ...
        <h1 className='excelent_title'>Ommabop Mahsulotlar</h1>
        <Swiper
      spaceBetween={40}
      slidesPerView={6}
      navigation
    ...
    >
     {
            products?.products?.filter(ft => ft.type?.includes("ommabop")).map(pr => (
                <SwiperSlide key={pr._id}>
                    <div  className="excelent_product">
                        <div className='new_product_price'><span >Hit savdo</span></div>
